      ...
      <div className="container">
        <div className="row gx-xl-5">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <SectionTitle
              subtitle={<Trans i18nKey="aboutv2.subtitle">{subtitle}</Trans>}
              title={<Trans i18nKey="aboutv2.title">{title}</Trans>}
              description={
                <Trans i18nKey="aboutv2.description">{description}</Trans>
              }
            />
              ...
              {items.map((data, i) => (
                <div key={i} className="about2__items--single">
                  ...
                  <div className="about2__items--text">
                    <h3>
                      <Trans i18nKey={`aboutv2.items${i + 1}.title`}>
                        {data.title}
                      </Trans>
                    </h3>
                    <p>
                      <Trans i18nKey={`aboutv2.items${i + 1}.desc`}>
                        {data.desc}
                      </Trans>
                    </p>
                  </div>
            ...
            <div className="about2__image">
              ...
              <div className="about2__image--promo">
                ...
                <div className="about2__image--promo--text">
                  ...
                  <Trans i18nKey="aboutv2.using">{using}</Trans>
                </div>
              </div>
            </div>
          </div>
